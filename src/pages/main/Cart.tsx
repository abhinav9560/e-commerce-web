        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cart.items
              .map((item: CartItem) => {
                ...
                const imageUrl =
                  product.images[0]?.url && product.images.length > 0
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              disabled={
                                item.quantity <= 1 || updatingItems[productId]
                              }
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <button
                disabled
                className="w-full mt-6 px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold opacity-50"
              >
                Proceed to Checkout
              </button>
